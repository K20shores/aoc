...
#	12/23/2015
#
#	Lights, lights, lights!	How many lights are left on after the expression
...
def main():
	...
	lights = { (i,j):-1 for i in range(0,1000) for j in range(0,1000) }
	...
	print "The number of lights left on is %d." %( 1000 * 1000 + sum(lights.values()))
